...
% Load images
% ----------------------------
ir = im2double(imread("IR_meting016_g.bmp"));
vi = im2double(imread("VIS_meting016_r.bmp"));
...
% deviation
dev_vi = deviation_1(vi, fused);
dev_ir = deviation_1(ir, fused);
...
fprintf('Deviation (VI): %.4f\n', dev_vi);
fprintf('Deviation (IR): %.4f\n', dev_ir);
